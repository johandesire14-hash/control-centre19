...
function NavigationGuard({ fontsLoaded }: { fontsLoaded: boolean }) {
  ...
  useEffect(() => {
    ...
    // (client tabs or garage dashboard). Capture segments before the async call
    // so the closure comparison is never stale.
  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen name="onboarding/garage" options={{ headerShown: false, presentation: "modal" }} />
        ...
        <Stack.Screen name="support" options={{ title: "Support & Assistance" }} />
