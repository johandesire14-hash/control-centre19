...
import { Bell, Moon, HelpCircle, ChevronRight, FileText, Shield, Trash2, Headset } from "lucide-react-native";
...
export default function SettingsScreen() {
  ...
  return (
    ...
    <KeyboardAwareScrollViewCompat style={{ backgroundColor: colors.background }} contentContainerStyle={styles.container}>
      ...
      >
        <View style={styles.toggleLabel}>
          <Headset size={16} color={colors.foreground} />
          <Text style={[styles.toggleText, { color: colors.foreground }]}>Support & Assistance</Text>
        </View>
